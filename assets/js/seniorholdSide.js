...
// &per_page=40 gør at vi går returneret 40 posts, og det sidste query parameter (&categories=55) spørger vi specifikt efter posts hvor kategorien har ID'et 55, som i dette tilfælde er seniorhold.
...
// En fetch request hvor vi specifikt søger efter post med ID'et 228, som i dette tilfælde er seniorafdelingen. Dette skal bruges for at tilføje formanden for denne afdeling til siden
fetch(domain + "wp-json/wp/v2/posts/228")
.then(res => res.json())
.then(data => renderResponsable(data))
.catch(err => console.log(err))

// En funktion som modtager data fra tiligere fetch request. Den tidligere fetch request modtog data fra "seniorafdelingen" indlæget, men vi er kun interesseret i at finde formanden for afdelingen.
